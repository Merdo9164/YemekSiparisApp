...
class SepetAdapter(private val mContext: Context,
                   private var sepetListesi: List<SepetYemekler>
) : RecyclerView.Adapter<SepetAdapter.CardTasarimTutucu>() {


    inner class CardTasarimTutucu(val sepettasarim: CardTasarimSepetBinding) : RecyclerView.ViewHolder(sepettasarim.root)
    ...
    override fun onBindViewHolder(holder: CardTasarimTutucu, position: Int) {
        ...
        val t = holder.sepettasarim
            ...
            t.sepetCardToplamFiyat.text = "${sepetYemek.yemek_fiyat !! * sepetYemek.yemek_siparis_adet} ₺"
